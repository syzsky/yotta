...
Generated from the strict Node Authoring Projection `sha256:1d35dc060fe291efca29c643362824cb82445dc981e210edfd04c2396338ed5b`. Do not edit.
...
- Node version: `1.0.0`
- Authoring projection: `sha256:1d35dc060fe291efca29c643362824cb82445dc981e210edfd04c2396338ed5b`
...
| input | `pulse` | `https://schemas.yotta.dev/types/time/duration-milliseconds/v1` | `durable` | `durable` | `default-available` | `200` |
...
| `forwardKey` | `text` | no | `minLength: 1, maxLength: 256, default hint: "W"` |
| `headingField` | `text` | no | `minLength: 1, maxLength: 256, default hint: "cameraHeading"` |
| `path` | `text` | no | `minLength: 1, maxLength: 256, default hint: "/v1/position"` |
| `slot` | `text` | yes | `minLength: 1, maxLength: 128, pattern: ^[a-z][a-z0-9]*(?:[-_][a-z0-9]+)*$` |
| `source` | `text` | yes | `minLength: 1, maxLength: 128, pattern: ^[a-z][a-z0-9]*(?:[-_][a-z0-9]+)*$` |
| `timeField` | `text` | no | `minLength: 1, maxLength: 256, default hint: "sampleTimeMs"` |
| `turnSign` | `select` | no | `enum: -1, 1, default hint: 1` |
| `validField` | `text` | no | `minLength: 1, maxLength: 256, default hint: "valid"` |
| `xField` | `text` | no | `minLength: 1, maxLength: 256, default hint: "x"` |
| `yField` | `text` | no | `minLength: 1, maxLength: 256, default hint: "y"` |
