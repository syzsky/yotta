...
Generated from the strict Node Authoring Projection `sha256:d429270b67949b4a16b6ebba90bfa41ad57b7df6e623626528f2f884b26bc791`. Do not edit.
...
- Node version: `1.0.0`
- Authoring projection: `sha256:d429270b67949b4a16b6ebba90bfa41ad57b7df6e623626528f2f884b26bc791`
...
- Availability: `target-required`
- Execution: `effect` / `recorded` / cache `none`
- Program instruction: `invoke` `{"kind":"invoke","invoke":{"branches":[{"output":"moving","coalesce":true},{"output":"marker"},{"output":"recover"}]}}`
- Host features: none
- Capabilities: none
- Run state access:
...
| output | `point-name` | `https://schemas.yotta.dev/types/core/string/v1` | `durable` | `durable` | `output` | — |
| output | `progress` | `https://schemas.yotta.dev/types/core/number/v1` | `durable` | `durable` | `output` | — |
| output | `recovery-attempt` | `https://schemas.yotta.dev/types/core/integer/v1` | `durable` | `durable` | `output` | — |
| output | `reason` | `https://schemas.yotta.dev/types/core/string/v1` | `durable` | `durable` | `output` | — |

| Configuration field | Control | Required | Constraints |
| --- | --- | --- | --- |
| `action-interval` | `integer` | no | `minimum: 100, maximum: 60000, default hint: 500` |
| `forwardKey` | `text` | no | `default hint: "W"` |
| `marker-mode` | `select` | no | `enum: "continue", "pause", default hint: "continue"` |
| `position-variable` | `state-variable` | yes | `minLength: 1, maxLength: 128` |
| `recovery-attempts` | `integer` | no | `minimum: 0, maximum: 20, default hint: 2` |
...
| `navigation.path.height-mismatch` | `progress` |
| `navigation.path.input-conflict` | `progress` |
| `navigation.path.progress` | `progress` |
| `navigation.path.recovering` | `progress` |
| `navigation.path.reference-mismatch` | `progress` |
| `navigation.path.stuck` | `progress` |
| `navigation.path.turning-stuck` | `progress` |
| `navigation.path.unavailable` | `progress` |
